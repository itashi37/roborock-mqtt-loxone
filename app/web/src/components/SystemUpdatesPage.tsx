...
const inputPurpose = (field: string) => ({ bridge_alive: 'Bridge process running (digital)', cloud_connected: 'Roborock cloud connection (digital)', bridge_heartbeat: 'Timestamp sent every 30 seconds (analog)', robot_online: 'Robot reachable (digital)' }[field] || `${humanize(field)} value`);
